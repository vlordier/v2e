...
See [`plans/v2e-v2-research-roadmap.md`](plans/v2e-v2-research-roadmap.md) for a concrete v2e-v2 plan covering soft refractory recovery, defect maps, dynamic thresholds, richer temporal pixel models, calibration tooling, and hybrid neural residuals.
