...
class gradients(
    ...
    BUMP_WIDTH = 0.5  # width of the triangular bump as fraction of width of array
    ...
    def __init__(
        ...
        logger.info(
            f"speed(pixels/s): {self.speed_pps}\n"
    ...
    def next_frame(self) -> tuple[np.ndarray | None, float]:
        ...
        if (
            ...
            and time > self.last_frame_written_time + 1.0 / 30.0
        ):
